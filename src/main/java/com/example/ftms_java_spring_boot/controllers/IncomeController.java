...
public class IncomeController {
  ...
  @Autowired
  public IncomeController(BusinessService businessService, TransactionService transactionService, BalanceService balanceService, UserService userService) {
  ...
  public String incomeHome(Model model) {
    List<Transaction> transactions = transactionService.getUserIncomes();
  ...
  public String incomeEdit(@PathVariable Long id, Model model) {
  ...
  public String saveIncome(
    ...
    try {
        ...
        model.addAttribute("title", id.isEmpty() ? "Add Income" : "Update Income");
